...
class ResetPasswordNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line(trans('mail.reset_password.line_1'))
            ->action(trans('mail.reset_password.action'), $url)
            ->line(trans('mail.reset_password.line_2', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.expire')]))
            ->line(trans('mail.reset_password.line_3'));
    }
