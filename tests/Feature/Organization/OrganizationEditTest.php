...
class OrganizationEditTest extends TestCase
{
    ...
    {
        [$organization, $group, $user] = $this->getOrgGroupUser();
    ...
    {
        [$organization, $group, $user] = $this->getOrgGroupUser('Principal');
    ...
    {
        [$org, $group, $user] = $this->getOrgGroupUser('Admin');
    ...
    {
        [$organization, $group, $user] = $this->getOrgGroupUser('Admin');
    ...
    public function organization_eats_onsite_is_updated_in_database()
    {
        ...
        Livewire::test('organizations.edit', compact('organization'))
            ->set('eatsOnsite.breakfast', false)
            ->call('updateOrg')
            ->assertHasNoErrors()
            ->assertEmitted('server-message', [
                'type' => 'success',
        ...
        $this->assertSame(false, $updatedOrganization->settings['eats_onsite']['breakfast']);
    }
