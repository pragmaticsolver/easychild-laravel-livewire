...
return [
    ...
    "attributes" => [
        ...
        "name" => "اسم",
        "organization_id" => "تنظيم",
        "parent_email" => "البريد الإلكتروني الأصل",
        "password" => "كلمة السر",
        "role" => "دور",
        "street" => "شارع",
        "title" => "عنوان",
    ...
    "passwords_validator" => [
        "data_leak" => "تم عرض :attribute في تسرب للبيانات. الرجاء إختيار :attribute آخر.",
        "letters" => "يجب أن يحتوي :attribute على حرف واحد على الأقل.",
        "mixed_cases_lowercase" => "يجب أن يحتوي :attribute على حرف صغير واحد على الأقل.",
        "mixed_cases_uppercase" => "يجب أن يحتوي :attribute على حرف كبير واحد على الأقل.",
        "numbers" => "يجب أن يحتوي :attribute على رقم واحد على الأقل.",
        "symbols" => "يجب أن يحتوي :attribute على حرف خاص واحد على الأقل."
    ],
